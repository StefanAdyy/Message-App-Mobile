...
public class SignUpActivity extends AppCompatActivity {
    ...
    private String encodedImage (Bitmap bitmap){
        int prewiewWidth = 150;
        int previewHeight = bitmap.getHeight() * prewiewWidth / bitmap.getWidth();
        Bitmap previewBitmap = Bitmap.createScaledBitmap(bitmap, prewiewWidth, previewHeight, false);
    ...
    private  Boolean isValidSignUpDetails(){
        if (encodedImage == null){
            ...
            showToast("Enter an email adress");
            return false;
            ...
            showToast("Password and confirmation must be identical");
            return false;
        }else{
            return true;
        }
