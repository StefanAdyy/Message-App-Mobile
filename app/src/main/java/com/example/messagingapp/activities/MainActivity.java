...
import com.example.messagingapp.adapters.RecentConversationAdapter;
...
public class MainActivity extends AppCompatActivity implements ConversationListener {
    ...
    private void init()
    {
        ...
        binding.conversationRecylerView.setAdapter(conversationAdapter);
    ...
    private final EventListener<QuerySnapshot> eventListener = (value , error)->{
        ...
        if(value!=null){
            for(DocumentChange documentChange:value.getDocumentChanges()){
                if(documentChange.getType()==DocumentChange.Type.ADDED){
                    ...
                    for(int i=0;i<conversations.size();i++){
                        ...
                        if(conversations.get(i).senderId.equals(senderId)&&conversations.get(i).receiverId.equals(recevierId)){
            ...
            binding.conversationRecylerView.setVisibility(View.VISIBLE);
    ...
    @Override
    public void onConversatoinClicked(User user){
